<?php namespace App\Http\Controllers;
	...
	class AdminAuthorsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Bank Account","name"=>"bank_account"];
			...
			$this->form[] = ['label'=>'Bank Account','name'=>'bank_account','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
