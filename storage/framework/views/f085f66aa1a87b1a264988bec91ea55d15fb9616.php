            ...
            <div class='col-sm-12'>
              ...
              <form method='get' action='' id='form-privilege'>
                ...
                <select class='form-control' onChange="$('#form-privilege').submit()" name='id_cms_privileges'>                  
                    <?php $__currentLoopData = $privileges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('crudbooster::admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/code/aroka-book-store/vendor/crocodicstudio/crudbooster/src/views/menus_management.blade.php ENDPATH**/ ?>