...
<div id='app' class="wrapper">    
    ...
    <nav class="navbar navbar-static-top">
      <div class="container">
        <div class="navbar-header">          
          <a href="<?php echo e(url(config('crudbooster.ADMIN_PATH'))); ?>" title='<?php echo e(CRUDBooster::getSetting('appname')); ?>' class="navbar-brand"><?php echo e(CRUDBooster::getSetting('appname')); ?></a>
        ...
        <div class="navbar-custom-menu">
          <ul class="nav navbar-nav">
            ...
            <li><a href="<?php echo e(CRUDBooster::mainpath()); ?>"><i class='fa fa-sign-out'></i> Exit</a></li>
          </ul>
        </div>
        <!-- /.navbar-custom-menu -->
      </div>
      ...
      <ul>
        <li class='connectedSortable' title='Drag To Main Area'>
            <div id='btn-smallbox' class='button-widget-area'>
                <a href="#" data-component='smallbox' class='btn-add-widget add-small-box'>
                    <img src='<?php echo e(asset("vendor/crudbooster/assets/statistic_builder/smallbox.png")); ?>'/>
        ...
        <li class='connectedSortable' title='Drag To Main Area'>
            <div id='btn-table' class='button-widget-area'>
                ...
                <img src='<?php echo e(asset("vendor/crudbooster/assets/statistic_builder/table.png")); ?>'/>
        ...
        <li class='connectedSortable' title='Drag To Main Area'>
            <div id='btn-chartarea' class='button-widget-area'>
                ...
                <img src='<?php echo e(asset("vendor/crudbooster/assets/statistic_builder/chart_area.png")); ?>'/>
        ...
        <li class='connectedSortable' title='Drag To Main Area'>
            <div id='btn-panelarea' class='button-widget-area'>
                ...
                <img src='<?php echo e(asset("vendor/crudbooster/assets/statistic_builder/panel.png")); ?>'/>
        ...
        <li class='connectedSortable' title='Drag To Main Area'>
            <div id='btn-chartarea' class='button-widget-area'>
                ...
                <img src='<?php echo e(asset("vendor/crudbooster/assets/statistic_builder/chart_line.png")); ?>'/>
        ...
        <li class='connectedSortable' title='Drag To Main Area'>
            <div id='btn-chartarea' class='button-widget-area'>
                ...
                <img src='<?php echo e(asset("vendor/crudbooster/assets/statistic_builder/chart_bar.png")); ?>'/>
    ...
    <footer class="main-footer">
        ...
        <div class="pull-right hidden-xs"> 
            Powered By <?php echo e(CRUDBooster::getSetting('appname')); ?>
...
<!-- Optionally, you can add Slimscroll and FastClick plugins.
      ...
      user experience -->
      <!-- SlimScroll 1.3.0 -->
        <script src="<?php echo e(asset('vendor/crudbooster/assets/adminlte/plugins/slimScroll/jquery.slimscroll.min.js')); ?>"></script>
</body>
</html><?php /**PATH /home/vagrant/code/aroka-book-store/vendor/crocodicstudio/crudbooster/src/views/statistic_builder/layout.blade.php ENDPATH**/ ?>