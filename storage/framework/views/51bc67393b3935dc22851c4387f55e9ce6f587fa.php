...
<header class="main-header">
    ...
    <!-- Logo -->
    <a href="<?php echo e(url(config('crudbooster.ADMIN_PATH'))); ?>" title='<?php echo e(CRUDBooster::getSetting('appname')); ?>' class="logo"><?php echo e(CRUDBooster::getSetting('appname')); ?></a>
        ...
        <div class="navbar-custom-menu">
            ...
            <li class="dropdown notifications-menu">
                ...
                <ul id='list_notifications' class="dropdown-menu">
                  ...
                  <li class="footer"><a href="<?php echo e(route('NotificationsControllerGetIndex')); ?>?m=0"><?php echo e(trans("crudbooster.text_view_all_notification")); ?></a></li>
                </ul>
              </li>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            <div class="pull-<?php echo e(trans('crudbooster.right')); ?>">
                                <a href="<?php echo e(route('AdminCmsUsersControllerGetProfile')); ?>?m=0" class="btn btn-default btn-flat"><i class='fa fa-user'></i> <?php echo e(trans("crudbooster.label_button_profile")); ?></a>
                            </div>
