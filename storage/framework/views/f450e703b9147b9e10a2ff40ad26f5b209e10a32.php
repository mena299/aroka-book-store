            <script type="text/javascript">
                  $(document).ready(function() {                      
                      ...
                      $('.selected-action ul li a').click(function() {
                        ...
                        if(confirm("<?php echo e(trans("crudbooster.alert_delete_selected")); ?>")) {                            
                          $('#form-table').submit();
                        }
                      })
                            ...
                            <div class='row between-group' style="<?php echo e((CRUDBooster::getTypeFilter($col["field_with"]) == 'between')?"display:block":"display:none"); ?>">
                              <div class='col-sm-6'>
                                <div class='input-group'>
                                  ...
                                  <input type='text' class='filter-value-between form-control <?php echo e((in_array($col["type_data"],["date","time","datetime","timestamp"]))?"datepicker":""); ?>' readonly placeholder='<?php echo e($col["label"]); ?> <?php echo e(trans("crudbooster.filter_from")); ?>' name='filter_column[<?php echo e($col["field_with"]); ?>][value][]' value='<?php
                              ...
                              <div class='col-sm-6'>
                                <div class='input-group'>
                                  ...
                                  <input type='text' class='filter-value-between form-control <?php echo e((in_array($col["type_data"],["date","time","datetime","timestamp"]))?"datepicker":""); ?>' readonly placeholder='<?php echo e($col["label"]); ?> <?php echo e(trans("crudbooster.filter_to")); ?>' name='filter_column[<?php echo e($col["field_with"]); ?>][value][]' value='<?php
                                  $value = CRUDBooster::getValueFilter($col["field_with"]); 
            ...
            <?php endif; ?><?php /**PATH /home/vagrant/code/aroka-book-store/vendor/crocodicstudio/crudbooster/src/views/default/table.blade.php ENDPATH**/ ?>