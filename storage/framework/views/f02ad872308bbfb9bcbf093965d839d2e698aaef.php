	...
	<script type="text/javascript">
        ...
        function addWidget(id_cms_statistics,area,component) {      
            ...
            $.post("<?php echo e(CRUDBooster::mainpath('add-component')); ?>",{component_name:component,id_cms_statistics:id_cms_statistics,sorting:sorting,area:area},function(response) {
            ...
            $(".connectedSortable").sortable({
                ...
                update: function(event, ui){
                    if(ui.sender){
                        ...
                        $.post("<?php echo e(CRUDBooster::mainpath('update-area-component')); ?>",{componentid:componentID,sorting:index,areaname:areaname},function(response) {
